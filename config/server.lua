        ...
        locations = {
            ...
            },
            {
                ...
                buys = {
                    ...
                    silver_ring = 30,
                    platinum_ring = 70,
                    gold_diamond_ring = 170,
                    gold_emerald_ring = 150,
                    gold_ruby_ring = 150,
                    gold_sapphire_ring = 150,
                    silver_diamond_ring = 150,
                    silver_emerald_ring = 130,
                    silver_ruby_ring = 130,
                    silver_sapphire_ring = 130,
                    platinum_diamond_ring = 190,
                    platinum_emerald_ring = 170,
                    platinum_ruby_ring = 170,
                    platinum_sapphire_ring = 170,
                    gold_necklace = 50,
                    silver_necklace = 30,
                    platinum_necklace = 70,
                    gold_diamond_necklace = 170,
                    gold_emerald_necklace = 150,
                    gold_ruby_necklace = 150,
                    gold_sapphire_necklace = 150,
                    silver_diamond_necklace = 150,
                    silver_emerald_necklace = 130,
                    silver_ruby_necklace = 130,
                    silver_sapphire_necklace = 130,
                    platinum_diamond_necklace = 190,
                    platinum_emerald_necklace = 170,
                    platinum_ruby_necklace = 170,
                    platinum_sapphire_necklace = 170,
                    gold_earring = 25,
                    silver_earring = 15,
                    platinum_earring = 35,
                    gold_diamond_earring = 150,
                    gold_emerald_earring = 130,
                    gold_ruby_earring = 130,
                    gold_sapphire_earring = 130,
                    silver_diamond_earring = 130,
                    silver_emerald_earring = 110,
                    silver_ruby_earring = 110,
                    silver_sapphire_earring = 110,
                    platinum_diamond_earring = 175,
                    platinum_emerald_earring = 160,
                    platinum_ruby_earring = 160,
                    platinum_sapphire_earring = 160,
                    diamond = 100,
                    emerald = 80,
                    ruby = 80,
                    sapphire = 80,
